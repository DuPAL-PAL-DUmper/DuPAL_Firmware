...
SRC = src/main.c src/libs/ioutils/mcu_io.c src/libs/uart/uart.c src/libs/utils/strutils.c src/libs/shifter/shifter.c \
		src/libs/ioutils/ioutils.c src/libs/pal_types/PAL16L8.c src/libs/pal_types/PAL12L6.c src/libs/pal_types/PAL16R4.c \
		src/libs/pal_types/PAL16R6.c
